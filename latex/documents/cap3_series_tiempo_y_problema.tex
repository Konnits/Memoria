...
Sea $T$ el número total de observaciones disponibles. Dado un \textbf{tamaño máximo de historia} $h_{\max}$ y un \textbf{stride} $s \ge 1$, se generan ejemplos recorriendo la serie con una ventana deslizante. De manera simplificada, los índices \emph{anchor} se pueden escribir como:
\begin{equation}
